  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (res.data.user.role !== "admin") {
        return setError("This portal is for admin only");
      }
    ...
    <div className="login-container">
      ...
      <div className="login-branding">
        ...
        <div className="brand-content">
          <h1 className="brand-title">
            Welcome to Your<br />Admin Portal
          </h1>
        ...
        <div className="brand-features">
          <div className="feature-item">
            ...
            <div className="feature-text">
              <h3>Upload Gallery And resources</h3>
              <p>Upload Memories Of the events to portal</p>
            </div>
          </div>
          ...
          <div className="feature-item">
            ...
            <div className="feature-text">
              ...
              <p>Schedule Events and announcements for Clubs</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="login-form-container">
        <div className="login-form-wrapper">
          ...
          <p className="login-secure">Admin Portal • Secure Login</p>
        </div>
      </div>
    </div>
  );
